...
global.reloadHandler = async function(restatConn) {
  ...
  conn.bye = '𝙏𝙚 𝙎𝙖𝙡𝙞𝙨𝙩𝙚 𝘿𝙚𝙡 𝙈𝙚𝙟𝙤𝙧 𝙂𝙧𝙪𝙥𝙤 𝙈𝙖𝙡𝙙𝙞𝙩𝙭 𝙉𝙚𝙜𝙧𝙭 @user 🥝';
  conn.spromote = '𝙀𝙮 @user 𝙁𝙪𝙞𝙨𝙩𝙚 𝙋𝙧𝙤𝙢𝙤𝙫𝙞𝙙𝙤 𝘼 𝘼𝙙𝙢𝙞𝙣 𝙀𝙣 𝙀𝙡 𝙈𝙚𝙟𝙤𝙧 𝙂𝙧𝙪𝙥𝙤 🥝';
  conn.sdemote = '𝙀𝙮 @user 𝙁𝙪𝙞𝙨𝙩𝙚 𝘿𝙚𝙜𝙧𝙖𝙙𝙖𝙙𝙤 𝘼 𝙋𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖𝙣𝙩𝙚 𝙉𝙤𝙧𝙢𝙖𝙡 𝙀𝙣 𝙀𝙡 𝙈𝙚𝙟𝙤𝙧 𝙂𝙧𝙪𝙥𝙤 🥝';
...
setInterval(async () => {
  ...
  const bio = `𝗘𝘀𝘁𝗲 𝗨𝘀𝘂𝗮𝗿𝗶𝗼 𝗛𝗮𝗰𝗲 𝗨𝘀𝗼 𝗗𝗲 𝗔𝗹𝗮𝗰𝗿𝗮𝗻 𝗕𝗼𝘁 - 𝗞𝗶𝘄𝗶 𝗕𝗼𝘁 🥝`;
